...
func CookieMiddleware(rdb *redis.Client) gin.HandlerFunc {
	paths := []string{"/user", "/merge", "/entry", "/search", "/entriescsv", "/clicks", "/clickcsv", "/haspassword", "/emailexchange", "/customcheck", "/multipass", "/webhook", "/administrative", "/check", "/verifyturn"}
